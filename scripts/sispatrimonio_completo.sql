-- =============================================
-- SisPatrimonio - Script Completo para MariaDB
...
-- 8. Bens patrimoniais (inclui veiculos)
...
-- admin123 -> $2a$12$LJ3m4ys3GnGqSWcCzPBHOeTSJCGhSMnAcz6oGqEADqhPxH6pMrDm2
-- gestor123 -> $2a$12$wZ8mPVjRFDqIQ8lK3tSn3OZ.V5x9YWF9Gl4bVjP6nUK1qJhCZ3GHy
-- maria123 -> $2a$12$kY5jT2nXr8sWvLmN6qA1dO3hP7wB9xF4cG2jK8mN0rT5vX3yZ1aWe
-- joao123 -> $2a$12$nM8pQ5rT2vW9xB4cF6hJ3dK7lN0sY1gA3eI5jL8mO2qR4tU6wX9zCb
-- carlos123 -> $2a$12$qR4tU6wX9zCbE2gI5jL8mO0sY1dK7nM8pQ5rT2vW3aF6hJ3cN0lBe
-- ana123 -> $2a$12$tU6wX9zCbE2gI5jL8mO0sY1qR4dK7nM8pQ5rT2vW3aF6hJ3cN0lRe

INSERT INTO usuarios (id, nome, email, senha_hash, cargo, role, ativo, avatar, unidade_secretaria, unidade_departamento, criado_em, ultimo_acesso) VALUES
(1, 'Roberto Gomes', 'admin@prefeitura.gov.br', '$2a$12$LJ3m4ys3GnGqSWcCzPBHOeTSJCGhSMnAcz6oGqEADqhPxH6pMrDm2', 'Diretor de TI', 'administrador', 1, 'RG', NULL, NULL, '2023-01-15 00:00:00', '2025-02-10 00:00:00'),
(2, 'Claudia Ferreira', 'gestor@prefeitura.gov.br', '$2a$12$wZ8mPVjRFDqIQ8lK3tSn3OZ.V5x9YWF9Gl4bVjP6nUK1qJhCZ3GHy', 'Chefe do Patrimonio', 'gestor', 1, 'CF', NULL, NULL, '2023-03-20 00:00:00', '2025-02-09 00:00:00'),
(3, 'Maria Silva', 'maria@prefeitura.gov.br', '$2a$12$kY5jT2nXr8sWvLmN6qA1dO3hP7wB9xF4cG2jK8mN0rT5vX3yZ1aWe', 'Coordenadora de RH', 'assistente', 1, 'MS', 'Secretaria de Administracao', 'Recursos Humanos', '2023-06-10 00:00:00', '2025-02-08 00:00:00'),
(4, 'Joao Santos', 'joao@prefeitura.gov.br', '$2a$12$nM8pQ5rT2vW9xB4cF6hJ3dK7lN0sY1gA3eI5jL8mO2qR4tU6wX9zCb', 'Coordenador Pedagogico', 'assistente', 1, 'JS', 'Secretaria de Educacao', 'Coordenacao Pedagogica', '2023-08-05 00:00:00', '2025-02-07 00:00:00'),
(5, 'Carlos Souza', 'carlos@prefeitura.gov.br', '$2a$12$qR4tU6wX9zCbE2gI5jL8mO0sY1dK7nM8pQ5rT2vW3aF6hJ3cN0lBe', 'Gerente de Unidade', 'assistente', 1, 'CS', 'Secretaria de Saude', 'Atencao Basica', '2024-01-12 00:00:00', '2025-02-06 00:00:00'),
(6, 'Ana Oliveira', 'ana@prefeitura.gov.br', '$2a$12$tU6wX9zCbE2gI5jL8mO0sY1qR4dK7nM8pQ5rT2vW3aF6hJ3cN0lRe', 'Contadora Chefe', 'assistente', 0, 'AO', 'Secretaria de Financas', 'Contabilidade', '2024-03-22 00:00:00', '2025-01-15 00:00:00');

-- Secretarias gerenciadas (gestor Claudia - id 2)
...
-- Bens patrimoniais (10 bens regulares)
...
-- Veiculos (4 veiculos - tambem sao bens)
